...
git  url: 'https://github.com/jaysonzhao/openshift-tasks.git'
...
sh "${mvnCmd} deploy -DskipTests=true -DaltDeploymentRepository=nexus::default::http://nexus3-0020-nexus.apps.766f.open.redhat.com//repository/releases"
